...
export default function App() {
  ...
  useEffect(() => () => { if (animationRef.current) cancelAnimationFrame(animationRef.current); void microphoneRef.current?.close() }, [])
  ...
  const start = async () => {
    ...
    try {
      ...
      const startedAt = microphone.context.currentTime
      setRunning(true)
      const analyse = () => {
